    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("section_text", models.CharField(blank=True, max_length=100, null=True)),
                (
                    "section",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="shop.Section"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="renditions", to="shop.CustomImage"
                    ),
                ),
            ],
